...
#  define NHPOINTER_TO_INT(p) ((nhint)(p))
#  define NHPOINTER_TO_UINT(p) ((nhuint)(p))
#  define NHINT_TO_POINTER(i) ((nhpointer)(i))
#  define NHUINT_TO_POINTER(u) ((nhpointer)(u))
#elif (SIZEOF_LONG == SIZEOF_VOID_P)
#  define NHPOINTER_TO_INT(p) ((nhint)(nhlong)(p))
#  define NHPOINTER_TO_UINT(p) ((nhuint)(nhulong)(p))
#  define NHINT_TO_POINTER(i) ((nhpointer)(nhlong)(i))
#  define NHUINT_TO_POINTER(u) ((nhpointer)(nhulong)(u))
#else
